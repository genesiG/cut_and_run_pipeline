...
"""
step_7f_plotheatmap.py - Generate heatmaps over lost H3K27me3 sites (no clustering).

Mirrors step_8b_plotheatmap.py but reads matrices produced by step_7e_computematrix.py
(base_prefix = "k27me3_lost").  Sample order, color scheme, and intensity ranges
match step_8b exactly.
"""
...
plot_type  = "se"
color_maps = []
# Same color order as step_8b: K27me2, K27me3, CBX2, EZH2
color_list = [
...
max_intensity = "25 25 15 15 3 3 3 3"
plot_height   = 12
plot_width    = 3.5
...
regions_labels   = ["'Lost H3K27me3'"]
sort_using_samples = None
plot_title       = None
y_min            = None
y_max            = None #"25 25 15 15 3 3 3 3"
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate heatmaps over lost H3K27me3 sites (no clustering)"
    )
    ...
    global base_prefix, avg_summary_plot, min_intensity, max_intensity, y_min, y_max, x_label, y_label
